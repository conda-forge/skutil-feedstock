...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/skutil-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11095&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/skutil-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `skutil` can be installed with:

```
conda install skutil
```

It is possible to list all of the versions of `skutil` available on your platform with:
